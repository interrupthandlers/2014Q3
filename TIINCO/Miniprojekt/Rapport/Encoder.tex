...
The encoder has been implemented in Matlab and in accordance to steps described in the previous section. 

A Matlab function called EncodeCyclicSystematic() has been made which takes the generator polynomial and message vector as inputs and returns the codeword as output.  
